var campeones = [
    {
        ...
        imagen:"/img/archivos_campeones/ahri_Skin01.jpg",
        rol:[2,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/akali_skin01.jpg",
        rol:[0,2,6]
    ...
    },
    {
        name:"Akshan",
        description:"Tras abandonar la orden de los Kinkou y su título de Puño de la Sombra, Akali actúa ahora en solitario y está lista para convertirse en el arma mortal que necesita su gente. Aunque no renuncia a las enseñanzas de Shen, su maestro, ha jurado defender Jonia de sus enemigos, asesinándolos uno a uno. Los ataques de Akali son silenciosos, pero su mensaje se escucha con toda claridad: temed a la asesina sin maestro",
        imagen:"/img/archivos_campeones/Akshan_Skin01_splash.jpg",
        rol:[0,2,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/alistar_skin01.jpg",
        rol:[3,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/amumu_skin01.jpg",
        rol:[0,1,3,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/annie_skin01.jpg",
        rol:[2,3,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/ashe_skin01.jpg",
        rol:[4,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/aurelionsol_skin01.jpg",
        rol:[2,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/blitzcrank_skin01.jpg",
        rol:[3,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/Brand_Skin01.jpg",
        rol:[2,3,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/braum_skin01.jpg",
        rol:[3,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/camille_skin01.jpg",
        rol:[0,1,2,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/Corki_Skin01.jpg",
        rol:[4,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/Darius_Skin01.jpg",
        rol:[0,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/drmundo_skin01.jpg",
        rol:[0,1,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/Draven_Skin01.jpg",
        rol:[4,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/Diana_Skin01_(1).jpg",
        rol:[1,2,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/evelynn_skin01.jpg",
        rol:[1,2,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/Ezreal_Skin01.jpg",
        rol:[4,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/fiora_skin01.jpg",
        rol:[0,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/fizz_skin01.jpg",
        rol:[1,2,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/Galio_Skin01.jpg",
        rol:[2,3,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/garen_skin01.jpg",
        rol:[0,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/gragas_skin01.jpg",
        rol:[1,2,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/graves_skin01.jpg",
        rol:[1,4,6]
        ...
        imagen:"/img/archivos_campeones/Irelia_Skin01.jpg",
        rol:[0,1,6]
    },
    {
        name:"Janna",
        ...
        imagen:"/img/archivos_campeones/janna_skin01.jpg",
        rol:[3,6]
    },
    {
        name:"Jarvan IV",
        description:"Janna es un antiguo y misterioso espíritu del viento que ha aparecido para proteger a los desfavorecidos de Zaun. Aunque su presencia a menudo se revela en forma de una ráfaga refrescante o una furiosa tempestad, también puede manifestarse en su etérea figura material para alentar a los desamparados. Durante eones, Janna ha sido testigo del alzamiento y la caída de incontables civilizaciones. En todo ese tiempo, se ha mantenido fiel a su propósito de ofrecer ayuda a todo el que la necesite.",
        imagen:"/img/archivos_campeones/jarvaniv_skin01.jpg",
        rol:[0,1,6]
    ...
    },
    {
        ...
        imagen:"/img/archivos_campeones/jax_skin01.jpg",
        rol:[0,1,6]

    },{
        name:"Jhin",
        description:"Jhin es un meticuloso criminal psicópata que ve el asesinato como arte. Otrora prisionero jonio, fue liberado gracias a los sombríos tejemanejes del consejo de Jonia. Ahora, el asesino en serie trabaja como sicario de la secta. Con su pistola como pincel, la obra de Jhin muestra un arte brutal, tanto para las víctimas como para los espectadores. Encuentra un cruel placer en la escenificación atroz, lo cual lo convierte en un candidato sin igual para mandar el más poderoso de los mensajes: el terror.",
        imagen:"/img/archivos_campeones/jhin_skin01.jpg",
        rol:[5,6]
    },
    {
        name:"Jinx",
        description:"Jinx, una criminal perturbada e impulsiva de Zaun, vive para sembrar el caos sin importarle las consecuencias. Provoca las explosiones más ruidosas y cegadoras con su arsenal de armas letales para dejar un rastro de terror y destrucción a su paso. Jinx aborrece el aburrimiento y disfruta dejando su peculiar impronta allá donde va.",
        imagen:"/img/archivos_campeones/jinx_skin01.jpg",
        rol:[5,6]
    },
    {
        name:"Kai'Sa ",
        description:"Para sobrevivir entre depredadores, Kai'Sa se convirtió en uno. Perdida durante años sin esperanza de rescate, Kai'Sa " + ' sobrevivió a base de pura voluntad y una segunda piel simbiótica adaptada de una criatura viva del Vacío. Ahora, la Hija del Vacío emerge como una cazadora dividida entre dos mundos: el que la vio nacer y el que la hizo crecer <br>"' + "El peligro es real. El miedo es una ilusión" + ".- Kai'Sa ",
        imagen:"/img/archivos_campeones/kaisa_skin01.jpg",
        rol:[5,6]
